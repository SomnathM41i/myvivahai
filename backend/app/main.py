...
CHANGES: Added /api/files and /api/profiles routes.
"""
...
# ── New file & profile management routers ─────────────────────────────────────
...
app.include_router(files_router)     # GET/DELETE /api/files, reprocess, download
app.include_router(profiles_router)  # GET/PUT/DELETE /api/profiles, export
